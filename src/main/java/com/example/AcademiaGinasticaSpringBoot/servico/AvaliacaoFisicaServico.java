...
public interface AvaliacaoFisicaServico {

    /**
     * Cria uma Avaliação Física e salva no banco de dados.
     *
     * @param form - formulário referente aos dados para criação da Avaliação
    ...
    /**
     * Retorna uma Avaliação Física que está no banco de dados de acordo com seu
     * Id.
     *
     ...
     *
     * @return - Uma lista com todas as Avaliações Física que estão salvas no
     * DB.
     */
